...
if (container) {
    ...
    console.info(`Welcome! Thanks for visiting. 👋

This interactive portfolio features 3D graphics built with TypeScript and Three.js, with physics calculations running in a Web Worker for optimal performance. The fragment shader is a custom version of the Mesh Physical Shader. The site structure uses modern HTML and CSS with Grid Layout and CSS Variables.

Feel free to explore and connect with me on GitHub: https://github.com/Prasidhpshetty7

Questions? Reach out: shettyprasidh262@gmail.com 😎`);
